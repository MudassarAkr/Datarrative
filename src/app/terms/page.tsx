        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">4. Service Agreement and Deliverables</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">4.1 Project Scope</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">4.2 Client Responsibilities</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                  You agree to:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">5.1 Fees</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">5.2 Payment Schedule</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">5.3 Late Payments</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">6.1 Client Data</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">6.2 Deliverables</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">6.3 Portfolio Rights</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">7. Confidentiality</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">8. Warranties and Disclaimers</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">8.1 Service Warranty</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">8.2 Disclaimer</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">10.1 Termination by Client</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">10.2 Termination by DashCrafters</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Email: <a href="mailto:legal@dashcrafters.co.uk" className="text-primary-600 dark:text-primary-400 hover:underline">legal@dashcrafters.co.uk</a></p>
