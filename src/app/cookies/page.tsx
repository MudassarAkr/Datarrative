          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.4 Targeting/Advertising Cookies</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">6.3 Opt-Out Tools</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Digital Advertising Alliance: <a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline">DAA Opt-out Tool</a></li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Changes to This Cookie Policy</h2>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">Email: <a href="mailto:privacy@dashcrafters.co.uk" className="text-primary-600 hover:underline">privacy@dashcrafters.co.uk</a></p>
