            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mt-4">
                  To exercise these rights, please contact us at <a href="mailto:privacy@dashcrafters.co.uk" className="text-primary-600 hover:underline">privacy@dashcrafters.co.uk</a>
                </p>
              </section>
